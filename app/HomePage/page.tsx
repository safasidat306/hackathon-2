...
//       <Head>
//         <link
//           href="https://api.fontshare.com/v2/css?f[]=satoshi@1,2,3,4&display=swap"
//           rel="stylesheet"
//         />
//       </Head>
//       <div>
...
//               <div>
//                 <ul className='list-style-none '>
//                   <li><a href="/CategoryPage" className="w-full md:ml-8 md:w-52 mb-5 md:mb-12 inline-block text-center bg-black hover:bg-black/80 transition-all text-white px-14 py-4 rounded-full">Shop Now</a></li>
//                 </ul>
//               </div>
//             </section>
//             <section className="relative md:px-4 min-h-[448px] md:min-h-[428px] bg-cover bg-top xl:bg-[center_top_-1.6rem] bg-no-repeat bg-[url('/images/header-res-homepage.png')] md:bg-[url('/images/header-homepage.png')]">
...
//                 className="absolute max-sm:hidden right-7 xl:right-0 top-12 max-w-[76px] max-h-[76px] lg:max-w-24 lg:max-h-max-w-24 xl:max-w-[104px] xl:max-h-[104px] animate-[spin_4s_infinite]"
//               />
//               <Image src="/img.jpeg" alt="img" height={700} width={700} className='md:-mt-12' />
//             </section>
//           </div>
//         </div>
//         <Logos />
