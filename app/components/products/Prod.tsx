...
const Products = [
  { id: 1, name: "Gradient Graphic T-shirt", image: "/white.png", rating: 3.5, price: 145, discountPrice: null, discount: null },
  { id: 2, name: "Polo with Tipping Details", image: "/purple.png", rating: 4.0, price: 180, discountPrice: null, discount: null },
  { id: 3, name: "Black Striped T-shirt", image: "/line.png", rating: 5.0, price: 120, discountPrice: 150, discount: "-30%" },
  { id: 4, name: "SKINNY FIT JEANS", image: "/2.png", rating: 3.5, price: 240, discountPrice: 260, discount: "-20%" },
  { id: 5, name: "CHECKERED SHIRT", image: "/3.png", rating: 4.5, price: 180, discountPrice: null, discount: null },
  { id: 6, name: "SLEEVE STRIPED T-SHIRT", image: "/4.png", rating: 4.5, price: 130, discountPrice: 160, discount: "-30%" },
  { id: 7, name: "VERTICAL STRIPED SHIRT", image: "/5.png", rating: 5.0, price: 212, discountPrice: 232, discount: "-30%" },
  { id: 8, name: "COURAGE GRAPHIC T-SHIRT", image: "/6.png", rating: 4.0, price: 145, discountPrice: null, discount: null },
  { id: 9, name: "LOOSE FIT BERMUDA SHORTS", image: "/7.png", rating: 3.0, price: 80, discountPrice: null, discount: null },
];
      ...
      <div className="flex md:pt-20 md:pb-5 max-sm:pb-[10px] md:px-5 max-sm:px-2">
        <div className="flex justify-between md:gap-3 max-sm:px-6 max-sm:gap-[6px] my-2 max-sm:my-5">
          ...
          <div className="flex flex-row gap-[10px]">
            ...
            <Image src="/Icons/below.svg" alt="downward-icon" height={6.5} width={11.5} className="max-sm:hidden md:pt-5" />
          </div>
        </div>
        <div className="max-sm:mr-4 max-sm:mt-8">
          ...
          <div
            ...
            style={{ maxHeight: isFilterBarOpen ? "98vh" : "0" }}
          >
        ...
        {Products.map((Product) => (
          <div key={Product.id} className="flex flex-col gap-1 items-center max-sm:gap-1">
            <div className="w-[295px] h-[298px] rounded-[20px] bg-[#F0EEED] flex justify-center items-center">
              <Image src={Product.image} alt={Product.name} height={200} width={200} className="max-sm:w-[140px] max-sm:h-[140px]" />
            </div>
